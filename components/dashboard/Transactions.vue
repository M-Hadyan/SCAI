  ...
  <div class="col-xl-4">
    ...
    <div class="card card-custom card-stretch gutter-b">
      ...
      <div class="card-body pt-2">
        ...
        <!--begin::Item FROM API-->
        <div
          v-for="transation of transations"
...
export default {
  computed: {
    transations: {
      get() {
        return this.$store.state.userTransactions.transations
      },
    },
  },
  mounted() {
    this.getAllTransations()
  },
  methods: {
    ...mapMutations({
    ...
    ...mapActions({
      getAllTransations: 'userTransactions/getAllTransations',
    }),
  },
}
</script>
